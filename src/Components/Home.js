...
function Home() {
    ...
    return (
        <section>
            ...
            <div className="overview">
                <div className="container overviewLayout">
                    ...
                    <div className="numbers">
                        ...
                        <h3><span className="bigNumber">$85m+</span> of follow-on capital</h3>
            ...
            {/* start gray section */}
            <svg className="grayWave" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 280"><path fill="#f3f4f5" fill-opacity="1" d="M0,64L60,64C120,64,240,64,360,80C480,96,600,128,720,165.3C840,203,960,245,1080,256C1200,267,1320,245,1380,234.7L1440,224L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path></svg>
